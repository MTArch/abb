...
public class ImageUtils {
	...
	private static final String EXCEPTION_OCCURED_WHILE_COMPRESSING_THE_IMAGE = "Exception occured while compressing the image. ";
	...
	private static final String EXCEPTION_OCCURED_WHILE_DECOMPRESSING_THE_IMAGE = "Exception occured while decompressing the image. ";
	...
	public static byte[] compress(byte[] data) {
		...
		try {
			...
			log.error(EXCEPTION_OCCURED_WHILE_COMPRESSING_THE_IMAGE, exp);
		}
	...
	public static byte[] decompress(byte[] data) {
		...
		try {
			...
			log.error(EXCEPTION_OCCURED_WHILE_DECOMPRESSING_THE_IMAGE, exp);
		}
		byte[] output = outputStream.toByteArray();
