...
public class AccountController {
    ...
    @GetMapping(value = ABHAEnrollmentDBConstant.GET_ACCOUNTS_BY_DOCUMENT_CODE_ENROL)
    public ResponseEntity<Flux<AccountDto>> getAccountsByDocumentCodeEnrol(@PathVariable("documentCode") String documentCode) {
        log.info(ENROLLMENT_DB_LOG_MSG+"get data based on documentCode= "+documentCode+ENROLLMENT_DB_ACCOUNTS);
        return ResponseEntity.ok(accountService.getAccountsByDocumentCodeEnrol(documentCode));
    }
