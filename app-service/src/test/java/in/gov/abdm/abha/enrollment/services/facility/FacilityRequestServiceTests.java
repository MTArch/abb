...
class FacilityRequestServiceTests {
    ...
    void setup()
    {
        ...
        enrollmentStatusUpdate = new EnrollmentStatusUpdate();
        AccountActionDto accountActionDto1=new AccountActionDto("",LocalDateTime.now(),"","","","","","","",true);
        accountActionDto = new AccountActionDto();
        accountActionDto.setAction(accountActionDto1.getAction());
        accountActionDto.setCreatedDate(accountActionDto1.getCreatedDate());
        accountActionDto.setField(accountActionDto1.getField());
        accountActionDto.setHealthIdNumber(accountActionDto1.getHealthIdNumber());
        accountActionDto.setNewValue(accountActionDto1.getNewValue());
        accountActionDto.setPreviousValue(accountActionDto1.getPreviousValue());
        accountActionDto.setReactivationDate(accountActionDto1.getReactivationDate());
        accountActionDto.setReason(accountActionDto1.getReason());
        accountActionDto.setReasons(accountActionDto1.getReasons());
        accountActionDto.setNewAccount(accountActionDto1.isNewAccount());
    ...
    @Test
    void verifyFacilityByEnrollElseBlock()
    {
        transactionDto.setMobileVerified(true);
        transactionDto.setTxnId(UUID.fromString("a95fba05-c367-420b-b404-d8debd7f574a"));
        when(transactionService.findTransactionDetailsFromDB(any()))
                .thenReturn(Mono.just(transactionDto));
        receiverOtpTracker.setReceiver("reciever");
        ...
        when(jwtUtil.generateToken(any(),any()))
                .thenReturn("eyJhbGciOiJSUzUxMiJ9..MRkDhH6G9htrfyF813IpSyK3_wlWq7oX4avAWhWiV58mFZsuCochLHiI7Fg74eKeOKKkkF-j-amRGW56_V1TD1fwtyuUNYG1Qgc3PCxZEbGVVBkd5488Kb3KW1TJRMWcK3NY5sr1Vi-kmQHZBavSXH1PM5AfHQkYSlLS4YB74SBUG_yyF8ku2TQloOX-NnQ3YDSMeWT4giYqTvKq8u-L7999Wp9wzbEDoS9--GMEbuaHTeYRRMs3cGOZDB-5t_-RB0bp97idGHEfDv2qrWpysYsnrrGsLvX_Uts8DNr8_g-3Df743k2JskD0cfB-kKp8RDhw6Ysv8Mg50tG6e35E-72UOBnl2njc72k1ov2Rscj_vXfJuCQb2cWnXNZttGCpiIVheg42SDqHraPQw3CUu_2BAAsuG9IciPLy-kz2uOo5eeK-BVTpzUe4tsbiuKZiSeaSu09hQOC8SuiLPznS29rp3VFXohmL4YB6mrbeiQT8Yt7Rdz-9VEavA6SYty2WBlMxsVEIqMi_8aPLtgamtAcDkdfwG4BaGnIqJEGEUoRRdELHMOBraaGDMnHl9_Jma8Xjhex1YxMMjFsTAzVJtLjro3JNjXAVR0THL55yyjoFNyf3agw7SItWowe5c57TqnAp4XIiJztofmYblvXdBf2qtVmSCwF5xslwUqkHGe0");
        when(hidPhrAddressService.findByHealthIdNumber(any())).thenReturn(Mono.just(new HidPhrAddressDto()));
        when(hidPhrAddressService.updateHidPhrAddressById(any(),any())).thenReturn(Mono.just(new HidPhrAddressDto()));
        when(accountAuthMethodService.deleteAccountAuthMethodByHealthId(any())).thenReturn(Mono.empty());
        enrollmentStatusUpdate.setTxnId("a95fba05-c367-420b-b404-d8debd7f574a");
        enrollmentStatusUpdate.setVerificationStatus("Decline");
        enrollmentStatusUpdate.setMessage("valid");
        StepVerifier.create(facilityRequestService.verifyFacilityByEnroll(enrollmentStatusUpdate))
                .expectNextCount(1L).verifyComplete();
    }
    @Test
    void sendOtpForEnrollmentNumberElse()
    {
        when(rsaUtil.decrypt(""))
                .thenReturn("91-7367-5177-0131");
        accountDto.setVerificationStatus(PROVISIONAL);
    ...
    @Test
    void verifyOtpViaNotificationElse()
    {
        receiverOtpTracker.setReceiver("reciever");
        receiverOtpTracker.setVerifyOtpCount(1);
        receiverOtpTracker.setSentOtpCount(1);
        ...
        authMethods.add(AuthMethods.OTP);
        otp.setTxnId("558737e6-677c-4fde-b945-c8e7ce1b3519");
        otp.setOtpValue("$argon2id$v=19$m=8192,t=100,p=8$77+9Cw$lwsiQ4xSYcfd9OMS1tNKQfXdCnt8GO0/WiSxCZVYX7TvORWALjmU5zGbCiLIlh43liIZTsDUyJIxkw6HHA5CrvIV3PRS+55ny49iubxcY4t0SH1HNBOMlzh1xPeVt6sH6qd7wnaHCTJaBfyZiPvZYht5vshGXvDom/OP5FspUos");
        authData.setAuthMethods(authMethods);
        authData.setOtp(otp);
        authRequestDto.setAuthData(authData);
        StepVerifier.create(facilityRequestService.verifyOtpViaNotificationFlow(authRequestDto))
