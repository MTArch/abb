...
@ReactiveFeignClient(name="document-client", url="${enrollment.gateway.document.baseuri}", configuration = BeanConfiguration.class)
public interface DocumentFClient {
