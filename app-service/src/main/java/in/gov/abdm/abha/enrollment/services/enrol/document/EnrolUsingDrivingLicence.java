                                ...
                                .flatMap(accountDto -> {
                                    ...
                                    return transactionService.deleteTransactionEntity(enrolByDocumentRequestDto.getTxnId()).flatMap(responseEntity -> {
                                        ...
                                        if (accountDto.getStatus().equals(AccountStatus.DELETED.getValue())) {
                                            ...
                                            return prepareErolByDLResponse(accountDto, txnDto.getTxnId().toString(), false, !accountDto.getVerificationStatus().equals(PROVISIONAL), AbhaConstants.THIS_ACCOUNT_ALREADY_EXIST, requestHeaders);
                                        }
                                    });
