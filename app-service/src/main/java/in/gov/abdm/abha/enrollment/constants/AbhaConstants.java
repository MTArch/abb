...
public class AbhaConstants {
      public static final String VALIDATION_EMPTY_SCOPE_FIELD = "Scope cannot be null or empty";
      public static final String VALIDATION_EMPTY_LOGIN_ID_FIELD = "LoginId cannot be null or Empty";
      public static final String VALIDATION_EMPTY_OTP_SYSTEM_FIELD = "Otp System cannot be null or Empty";
      public static final String VALIDATION_NULL_LOGIN_HINT_FIELD = "Login Hint cannot not be null";
      ...
      public static final String MISSING_QUOTES_IN_KEY_ERROR_CONDITION = "was expecting double-quote to start field name";
      public static final String MISSING_QUOTES_IN_KEY_ERROR_MESSAGE = "JSON Syntax Error: Missing double quotes in the key part of JSON on line:";
      public static final String MISSING_QUOTES_IN_VALUE_ERROR_CONDITION = "was expecting (JSON String, Number, Array, Object or token 'null', 'true' or 'false')";
      public static final String MISSING_QUOTES_IN_VALUE_ERROR_MESSAGE = "JSON Syntax Error: Missing double quotes in the value part of JSON on line: ";
      public static final String MISSING_COLON_ERROR_CONDITION = "was expecting a colon to separate field name and value";
      public static final String MISSING_COLON_ERROR_MESSAGE = "JSON Syntax Error: Missing colon to separate the key part and the value part at line: ";
      public static final String MISSING_COMMA_ERROR_CONDITION = "was expecting comma to separate Object entries";
      public static final String MISSING_COMMA_ERROR_MESSAGE = "JSON Syntax Error: Missing comma at the end of line: ";
      public static final String SUCCESS_MESSAGE = "Entered Input is Valid";
      ...
      public static final String ACCOUNT_NOT_FOUND_EXCEPTION_MESSAGE = "No account found with AADHAAR Number.Please,create an account by clicking Click here to Create ABHA Number link.";
      ...
      public static final String VERIFICATION_STATUS_NOT_PROVISIONAL = "Verification status for this account is not Provisional";

      public static final String HEALTH_ID_NUMBER_NOT_FOUND_EXCEPTION_MESSAGE = "Invalid health id, either the health id is wrong or not found in db";
      ...
      public static final String INVALID_ABHA_NUMBER = "Invalid ABHA Number";
      ...
      public static final String INVALID_LINK_REQUEST_EXCEPTION_MESSAGE = "INVALID REQUEST FOR PARENT LINKING";

      public static final String INVALID_OTP = "Invalid OTP, Please try again.";

      public static final String EXPIRED_OTP = "OTP expired, Please try again.";
      ...
      public static final String INVALID_REQUEST = "Bad request, check request before retrying";

      public static final String INVALID_CLIENT_ID_IN_HEADERS = "Bad request, invalid clientId in headers.";

      public static final String DRIVING_LICENCE = "DRIVING_LICENCE";

      public static final String PROVISIONAL = "PROVISIONAL";

      public static final String VALIDATION_ERROR_TRANSACTION_ID_FIELD = "Transaction Id cannot be null or empty";

      public static final String VALIDATION_ERROR_DOCUMENT_TYPE_FIELD = "Document type cannot be null or empty";

      public static final String VALIDATION_ERROR_DOCUMENT_ID_FIELD = "Document Id cannot be null or empty";

      public static final String VALIDATION_ERROR_FIRST_NAME_FIELD = "First Name cannot be null or empty";

      public static final String VALIDATION_ERROR_MIDDLE_NAME_FIELD = "Middle Name cannot be null or empty";
      ...
      public static final String ABHA_ADDRESS_ALREADY_EXISTS_EXCEPTION_MESSAGE = "This Abha Address already exists. Please create with unique Abha Address";
