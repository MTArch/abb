...
public class AbhaConstants {
    ...
    public static final String EMAIL_ALREADY_LINKED_TO_MAX_ACCOUNTS = "The email Id provided by you is already linked to {0} ABHA Numbers. Please provide a different email Id.";
